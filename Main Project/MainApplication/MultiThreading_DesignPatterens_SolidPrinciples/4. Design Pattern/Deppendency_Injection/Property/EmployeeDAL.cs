...
namespace MainApplication.WPF_MVVM._4._Design_Pattern.Deppendency_Injection.Property
{
    ...
    public class EmployeeDAL : IEmployeeDAL
    {
        ...
        {
            List<Employee> ListEmployees = new List<Employee>();
            ListEmployees.Add(new Employee() { Id = 1, Name = "SanjayDIP", Department = "IT" });
            ListEmployees.Add(new Employee() { Id = 2, Name = "RamDIP", Department = "Accounts" });
            ListEmployees.Add(new Employee() { Id = 3, Name = "NareshDIP", Department = "Production" });
            return ListEmployees;
        }
    }
