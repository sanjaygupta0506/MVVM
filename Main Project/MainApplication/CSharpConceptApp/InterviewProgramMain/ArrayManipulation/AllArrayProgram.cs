...
namespace CSharpConceptApp.Interview_Logical.ArrayManipulation
{
    public class ArrayManipulation
    {
        public static void Main(string[] args)
        {
            ...
            #region 2. To Find Length of Array
            Console.WriteLine("\n*** 2. Length of Array ***");
            ...
            #region 16. Second Number from Array
            Console.WriteLine("\n*** 16. second highest number from array ***");
            int[] arr1 = { 3, 2, 1, 5, 4 };
            ...
            #region 17. calculate sum of all even numbers 
            Console.WriteLine("\n*** 17. calculate sum of all even numbers ***");
            int sumOfEvens = SumOfEvenNumbers(numbers3);
            Console.WriteLine($"Sum of even numbers: {sumOfEvens}");

            #endregion

            #region 18. Rotation of Array
            Console.WriteLine("\n*** 18. rotation of array ***");
