...
namespace MainApplication.WPF_MVVM._4._Design_Pattern.Deppendency_Injection.Method
{
    ...
    public class EmployeeDAL : IEmployeeDAL
    {
        ...
        {
            List<Employee> ListEmployees = new List<Employee>();
            ListEmployees.Add(new Employee() { Id = 1, Name = "SanjayDIM", Department = "IT" });
            ListEmployees.Add(new Employee() { Id = 2, Name = "RamDIM", Department = "Accounts" });
            ListEmployees.Add(new Employee() { Id = 3, Name = "NareshDIM", Department = "Production" });
            return ListEmployees;
        }
    }
}
